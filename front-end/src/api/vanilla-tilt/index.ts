export const VanillaTilt = (function () {
  ...
  class VanillaTilt {
    ...
    // -- Variable for Gyroscope sampling
    gammazero: number;
    betazero: number;
    lastgammazero: number;
    lastbetazero: number;
    ...
    gyroscope: boolean;
    gyroscopeSamples: any;

    elementListener: Node;

    constructor(element: Node, settings = {}) {
    ...
    static isSettingTrue(settings: any) {
      return settings === '' || settings === true || settings === 1;
    }
